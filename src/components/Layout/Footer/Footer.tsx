...
import Phone from "../../../assets/Logo/whatsapp.png";

const Footer = () => {
  return (
    <div className="absolute  block w-full">
      <div className="bg-gray-900 pb-5  lg:p-14 m-0 text-white">
      ...
      <Grid container>
        <Grid item  xs={12} className="bg-slate-800 ">
          <div className="p-3 text-center ">
            <span className="text-gray-300 text-1xl " >© 2023 JUMPSTART, Inc</span>
          </div>
        </Grid>
      </Grid>
    </div>

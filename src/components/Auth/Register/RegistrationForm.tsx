...
const RegistrationForm = (props: Props) => {
  ...
  return (
    <div className="shadow-lg   bg-white  ">
      <div className=" rounded-lg w-full mb-16 border-2" >
        <Typography
          variant="h4"
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Box className=" ">
            <Grid container className=" text-center inline-block 700 ">
                ...
                <Box className="mx-3 my-2">
                  <Box sx={{ display: "flex" }}>
                    <Grid container>
                      ...
                      <Grid item xs={10}>
                      <div className="text-[14px] font-bold text-center top-0">------------------- OR -------------------</div>
                      </Grid>
                      <Grid item xs={1}>

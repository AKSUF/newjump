...
import { assignRoles, getOtherUserRoles } from "../../../service/AuthService";
              ...
              {selected.map((value) => {
                switch (value) {
                  case 101:
                    ...
                    break;
                  case 102:
                    return <Chip key={value} label={"User"} />;
                    break;
                  case 103:
                    return <Chip key={value} label={"Employee"} />;
                    break;
                  case 104:
                    return <Chip key={value} label={"Producer"} />;
                    break;
                  case 105:
                    return <Chip key={value} label={"Rider"} />;
                    break;
                  case 106:
                    return <Chip key={value} label={"Store"} />;
                    break;
                    case 107:
                    return <Chip key={value} label={"Shipping Courier"} />;
                    break;
                }
              })}
            </Box>

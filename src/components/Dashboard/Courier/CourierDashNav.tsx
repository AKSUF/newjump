...
const CourierDashNav =  (props: Props) => {
  ...
  return (
    <div>
      <div className=" shadow-red-300 shadow-sm py-1 test fixed w-full left-0  top-0 z-20  backdrop-filter backdrop-blur-lg bg-opacity-60">

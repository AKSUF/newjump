...
import { addStoreDetails, getSingleStoreDetails, updateStores, uploadStoreImage } from "../../service/StoreService";
...
const EditStore = () => {
  ...
  useEffect(() => {
    getSingleStoreDetails(store_id,token)
      .then((res) => {
  ...
  const handleSubmit = (event: any) => {
    ...
    updateStores({...store}, token)
      .then((res) => {
        console.log(res.data.store_id);
        uploadStoreImage(store_id, imageFile, token)
          .then((data) => {
            ...
            <div className=" rounded-lg bg mb-16 border-2 border-gray-300 shadow-xl p-2">
              ...
              <form onSubmit={handleSubmit}>
                <div className="form-group   m-3 ">
                  ...
                  onChange={(event) => handleChange(event, "store_name")}   
          ...
          focus:text-gray-700 focus:bg-white focus:border-green-600 focus:outline-none required"
                ...
                <div className="flex">
                  <div className="form-group mb-1 m-3 w-6/12">
                    ...
                    <input
                      ...
                      name="opens"
                      value={store.opens}
                  onChange={(event) => handleChange(event, "opens")}   
                      className="form-control block
              w-full
              p-2
              py-1.5
             ...
             focus:text-gray-700 focus:bg-white focus:border-green-600 focus:outline-none"
                ...
                <div className="form-group mb-1 m-3">
                  ...
                  onChange={(event) => handleChange(event, "store_address")}   
                    className="form-control block
              w-full
              p-2
              py-1.5
             ...
             focus:text-gray-700 focus:bg-white focus:border-green-600 focus:outline-none"
                ...
                <div className="form-group mb-1 m-3">
                  ...
                  <textarea
                    id="store_desc"
                    name="store_desc"
                    value={store.store_desc}
                  onChange={(event) => handleChange(event, "store_desc")}   
                    className="form-control block
              w-full
              p-2
              py-1.5
